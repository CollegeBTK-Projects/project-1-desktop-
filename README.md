...
Простое приложение на ЯП Python используя библиотеку Flet.

![Python Coverage](https://img.shields.io/badge/python-3.13-3776AB?logo=python)
...
![Photo](https://app-for-cms.ru/files/uploads/app-order.jpg)